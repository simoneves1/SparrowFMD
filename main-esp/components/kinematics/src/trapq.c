...
inline float
move_get_distance(struct move *m, float move_time)
{
...
inline struct coord
move_get_coord(struct move *m, float move_time)
{
    float move_dist = move_get_distance(m, move_time);
    return (struct coord) {
...
void __visible
trapq_append(struct trapq *tq, float print_time
...
void __visible
trapq_finalize_moves(struct trapq *tq, float print_time
...
void __visible
trapq_set_position(struct trapq *tq, float print_time
